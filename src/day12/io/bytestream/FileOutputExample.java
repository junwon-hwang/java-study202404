...
public class FileOutputExample {
    ...
    public static void main(String[] args) {
        ...
        try (FileOutputStream fos = new FileOutputStream(FileExample.ROOT_PATH + "/test/pet.txt")) {
            // fos = new FileOutputStream(FileExample.ROOT_PATH + "/test/pet.txt");
        ...
        /* 요즘은 안씀 try(여기서 파일생성)
              ...
              // 보통 사용후 메모리 정리를 해줘야 다음 실행에 문제가 생길 여지가 줄어듬
            try {
